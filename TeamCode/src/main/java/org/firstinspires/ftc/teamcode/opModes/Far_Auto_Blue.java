...
@Autonomous(name = "Blue Far Auto", preselectTeleOp = "Drive")
public class Far_Auto_Blue extends NextFTCOpMode {
    public Far_Auto_Blue() {
        addComponents(
    ...
    private final Pose startPose = new Pose(56.661, 8.047, Math.toRadians(90));

    private final Pose initialFire = new Pose(59.835, 18.25, Math.toRadians(111.5));
    private final Pose spikeMark = new Pose(42.406, 48, Math.toRadians(180));


    private final Pose ballMark1 = new Pose(35, 48, Math.toRadians(180));
    private final Pose ballMark2 = new Pose(30, 48, Math.toRadians(180));
    private final Pose ballMark3 = new Pose(25, 48, Math.toRadians(180));


    private final Pose secondSpikeMarkPos = new Pose(57.406, 54.154, Math.toRadians(180));
    private final Pose secondBallMark1 = new Pose(51.210, 54.154, Math.toRadians(180));
    private final Pose secondBallMark2 = new Pose(46.210, 54.154, Math.toRadians(180));
    private final Pose secondBallMark3 = new Pose(39.210, 54.154, Math.toRadians(180));
