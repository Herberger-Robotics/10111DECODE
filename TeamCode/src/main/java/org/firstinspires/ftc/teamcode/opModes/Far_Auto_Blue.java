...
public class Far_Auto_Blue extends NextFTCOpMode {
    ...
    private final Pose initialFire = new Pose(57.835,17.434,Math.toRadians(114));

    private final Pose spikeMark = new Pose(50.406, 35, Math.toRadians(180));
    private final Pose ballMark1 = new Pose(46.210,35,Math.toRadians(180));
    private final Pose ballMark2 = new Pose(42.210,35,Math.toRadians(180));
    private final Pose ballMark3 = new Pose(36.210,35,Math.toRadians(180));
